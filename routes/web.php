...
Route::get('sites/import',           [SiteImportController::class, 'showForm'])->name('sites.import');
Route::post('sites/import',          [SiteImportController::class, 'import']);
Route::get('sites/import/template',  [SiteImportController::class, 'template'])->name('sites.import.template');
